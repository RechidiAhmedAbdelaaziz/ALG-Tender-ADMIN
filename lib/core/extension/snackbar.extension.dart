...
extension SnackbarExtension on BuildContext {
  void _showSnackbar(
      String message, Color color, Color textColor, IconData icon) {
  ...
  void showSuccessSnackbar(String message) => _showSnackbar(
      message, Colors.green, Colors.white, Icons.check_circle);
  ...
  void showWarningSnackbar(String message) => _showSnackbar(
      message, Colors.orange, Colors.white, Icons.warning);
}
